...
import { AdminCreateForgot, AdminUpdateForgot } from '../_actions/Forgot.action'
            ...
            <div className="auth-wrapper">
                <div className="auth-inner">
                    ...
                    <Form.Label>Email Address</Form.Label>
                            ...
                            <br></br>
                            <Button type="submit" onClick={EmailSubmit} block variant="success">Submit</Button> <br></br>
                        </div>}
                        ...
                        {props.createForgot.showOtp && <div>
                            ...
                            <Button type="submit" onClick={OtpSubmit} block variant="success">Submit</Button> <br></br>
                        </div>}
                        ...
                        {pass && <div>
                            ...
                            <Button type="submit" onClick={PassSubmit} block variant="success">Submit</Button>
                        </div>
                        }
...
const mapDispatchToProps = (dispatch) => {
    return {
        forgotPass: (data) => dispatch(AdminCreateForgot(data)),
        editpass: (data) => dispatch(AdminUpdateForgot(data))
    }
}
