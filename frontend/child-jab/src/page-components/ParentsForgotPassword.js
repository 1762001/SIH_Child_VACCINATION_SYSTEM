...
import { CreateForgot, UpdateForgot } from '../_actions/Forgot.action'

function ParentsForgotPassword(props) {
            ...
            <div className="auth-wrapper">
                <div className="auth-inner">
                    ...
                    <Form.Label>Email Address</Form.Label>
                            ...
                            <br></br>
                            <Button type="submit" onClick={EmailSubmit} block>Submit</Button> <br></br>
                        </div>}
                        ...
                        {props.createForgot.showOtp && <div>
                            ...
                            <Button type="submit" onClick={OtpSubmit} block>Submit</Button> <br></br>
                        </div>}
                        ...
                        {pass && <div>
                            ...
                            <Button type="submit" onClick={PassSubmit} block>Submit</Button>
                        </div>
                        }
                        <p className="forgot-password text-right">
                            Back To <Link to='/host-login'>Sign In?</Link>
                        </p>
                    </Form>
                    </Card>
                    </Col>
...
export default connect(mapStateToProps, mapDispatchToProps)(ParentsForgotPassword)
